<x-dashboard title="Edit Galeri">
    <form action="{{ route('galleries.update', $gallery->id) }}" method="POST" class="p-4 m-4 rounded-lg shadow-xl bg-secondary"
        ...
        <div>
            ...
            <input type="text" name="title" id="title"
                ...
                placeholder="Masukkan Judul" required value="{{ old('title', $gallery->title) }}">
            @error('title')
        ...
        <div class="mt-4">
            ...
            <div class="flex gap-2">
                ...
                <div>
                    <img id="image-preview" src="{{ asset('storage/' . $gallery->image) }}" alt="image preview"
