<x-dashboard title="Tambah Kerjasama">
    <form action="{{ route('cooperations.store') }}" method="POST" class="p-4 m-4 rounded-lg shadow-xl bg-secondary"
        ...
        <div>
            ...
            <input type="text" name="name" id="name"
                ...
                placeholder="Masukkan Perusahaan" required value="{{ old('name') }}">
            @error('name')
